...
id: 85-Q1
description: "In this experiment you are required to determine the density of 
a liquid relative to that of another liquid, and find the mass
of the metre rule provided."
type: exam_question
------
...
Metre rule; thread (:math:`\approx` 50cm); fulcrum (eg. prism); fulcrum
support (height :math:`\approx` 10cm; :math:`L_1` 200ml water in 250ml
beaker; :math:`L_2` 200ml motor oil (or kerosene) in 250ml beaker;
:math:`W_1` 50g mass (metal); :math:`W_2` 20g mass (plastic or rubber);
...
(b) Set up the apparatus as illustrated below, where :math:`a = 5`\ cm,
    and :math:`W_1` and :math:`W2` are masses of 50g and 20g
    respectively. ‘

|85-Q1.1| 

(c) With :math:`W_2` totally immersed in liquid :math:`L_1` and
    :math:`x = 10`\ cm, balance the metre rule by adjusting the position
    of :math:`W_1`. Read and record distance :math:`y`. Repeat the
    process for :math:`X = 20`\ cm, 30cm, 40cm, 50cm, and 54cm. Tabulate
