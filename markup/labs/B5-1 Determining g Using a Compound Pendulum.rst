...
id: B5-1
description: "Simple to construct and conduct, this experiment finds the 
acceleration due to local gravity and centrifugal acceleration while also showing 
the moment of inertia of the compound pendulum about its axis of rotation."
type: lab
------
