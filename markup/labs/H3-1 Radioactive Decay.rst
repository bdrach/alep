...
id: H3-1
description: "A statistical sample models atomic processes to illustrate the 
half-life of a radioactive isotope. The steps described suggest the 
conservation of mass, charge, and energy in decay reactions."
type: lab
------
