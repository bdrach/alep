...
id: F1-2
description: "An electrical circuit having a resistor, a capacitor, and 
a power supply (RC circuit) is used to observe current and potential difference
for capacitors wired alone, in series, and in parallel. "
type: lab
------
