...
id: 86-Q3
description: "The aim of this experiment is to determine the electrical 
resistivity of the wire provided."
type: exam_question
------
...
Metre bridge & jockey; resistance wire (length :math:`\approx` 1m,
resistance :math:`\approx 2 \Omega` but not less); metre rule; resistors
(0.5\ :math:`\Omega`, 1\ :math:`\Omega`, 2\ :math:`\times` 2\ :math:`\Omega`,
5\ :math:`\Omega`, 10\ :math:`\Omega`, 20\ :math:`\Omega`); 1.5V cell;
...
(a) Set up a slide-wire metre bridge as illustrated below where **E** is
    ...
    jockey or slider **J** is placed at the 50cm mark.
...
(b) With **R** :math:`= 20 \Omega`, find the value of length :math:`l` for
    ...
    tapped onto the 50cm mark as shown below. (2 Marks)

(c) Repeat the procedure in (b) for values of **R** equal to
    10\ :math:`\Omega`, 5\ :math:`\Omega`, 2\ :math:`\Omega`,
    1\ :math:`\Omega`, and 0.5\ :math:`\Omega`. (8 marks)

|86-Q3.1| 

(i)   Calculate and tabulate the values of
      :math:`\frac{1}{R} \text{ and } \frac{1}{l}` for the values of
      :math:`R` equal to 20\ :math:`\Omega`, 10\ :math:`\Omega`,
      5\ :math:`\Omega`, 2\ :math:`\Omega`, 1\ :math:`\Omega`, and
      0.5\ :math:`\Omega` obtained in (b) and (c) above. (7 marks)
